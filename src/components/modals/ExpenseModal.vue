        ...
        <div class="w-full max-w-lg rounded-2xl bg-white border border-zinc-200/90 shadow-2xl p-6 my-8 space-y-4 max-h-[90vh] overflow-y-auto">
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-xs text-zinc-500">Track recurring maintenance, rates, taxes & bills</p>
            </div>
            <button
              @click="emit('close')"
          ...
          <form @submit.prevent="submit" class="space-y-4">
            ...
            <!-- Expense Name -->
            <div class="space-y-1">
              <label class="block text-xs font-medium uppercase tracking-wider text-zinc-500">Expense Title</label>
              <input
                v-model="form.name"
                type="text"
                required
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div class="space-y-1">
                <label class="block text-xs font-medium uppercase tracking-wider text-zinc-500">Due Day</label>
                <input
            ...
            <!-- Account Reference -->
            <div class="space-y-1">
              <label class="block text-xs font-medium uppercase tracking-wider text-zinc-500">Account / Reference #</label>
              <input
