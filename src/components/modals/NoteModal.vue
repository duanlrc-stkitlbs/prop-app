        ...
        <div class="w-full max-w-lg rounded-2xl bg-white border border-zinc-200/90 shadow-2xl p-6 my-8 space-y-4 max-h-[90vh] overflow-y-auto">
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-xs text-zinc-500">Inspections, tenant notes, key logs, history</p>
            </div>
            <button
              @click="emit('close')"
          ...
          <form @submit.prevent="submit" class="space-y-4">
            ...
            <!-- Title -->
            <div class="space-y-1">
              <label class="block text-xs font-medium uppercase tracking-wider text-zinc-500">Note Title</label>
              <input
                v-model="form.title"
                type="text"
                required
            ...
            <!-- Content -->
            <div class="space-y-1">
              <label class="block text-xs font-medium uppercase tracking-wider text-zinc-500">Note Content</label>
              <textarea
